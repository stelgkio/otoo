...
func Team(project *domain.Project, projectExtensions []*domain.ProjectExtension, user *domain.User) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"vstack gap-5 mt-8\"><div class=\"d-flex align-items-end justify-content-between\"><div><h3 class=\"fw-semibold mb-1\">Your Team</h3><p class=\"text-sm text-muted\">The new user can not add new extesion to project.</p></div><div><button type=\"button\" class=\"btn btn-neutral btn-sm\" data-bs-toggle=\"modal\" data-bs-target=\"#modalShare\"><span id=\"spinner\" class=\"htmx-indicator spinner-border spinner-border-sm\" role=\"status\" aria-hidden=\"true\" hx-boost=\"validate\"></span>Add team member</button></div></div><hr class=\"my-0\"><div class=\"row justify-content-between\"><div class=\"col-md-4\"><label class=\"form-label\">Members</label></div><div class=\"col-md-8 col-xl-7\" hx-get=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/project/settings/team/team.templ`, Line: 127, Col: 73}
		}
