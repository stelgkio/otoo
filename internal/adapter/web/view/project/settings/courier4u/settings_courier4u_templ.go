...
func SettingsCourier4u(projectId string, projectExtensions []*domain.ProjectExtension, user *domain.User, errors map[string](string), values *domain.Courier4uExtension) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if ConvertUserRole(user.Role) == "admin" {
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"d-flex align-items-end justify-content-between\"><div><h3 class=\"fw-semibold mb-1\">Courier4u</h3><p class=\"text-sm text-muted\">DeActivate extension and remove subscription</p></div><div><button data-bs-target=\"#DeActivateCourier4u\" data-bs-toggle=\"modal\" class=\"btn btn-sm btn-danger\"><span id=\"spinner4u\" class=\"htmx-indicator spinner-border spinner-border-sm\" role=\"status\" aria-hidden=\"true\"></span>DeActivate</button></div></div>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
