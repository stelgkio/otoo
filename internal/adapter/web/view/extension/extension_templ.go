		...
		for _, extension := range extensions {
			if extension.Code == "asc-courier" {
				...
				if domain.ContainsExtensionID(projectExtensions, extension.ID.Hex()) {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 113, Col: 76}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 137, Col: 76}
					}
				...
				if domain.ContainsExtensionID(projectExtensions, extension.ID.Hex()) {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 186, Col: 34}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 192, Col: 78}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 193, Col: 83}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 210, Col: 34}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 216, Col: 78}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/adapter/web/view/extension/extension.templ`, Line: 217, Col: 83}
					}
