...
func DeafultDashboard(projectId string, counts map[string]string, orders []*woo.OrderRecord, bestSeller []*woo.ProductBestSellerRecord) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div id=\"dashboard-content\" class=\"flex-fill overflow-y-lg-auto scrollbar bg-body rounded-top-4 rounded-top-start-lg-4 rounded-top-end-lg-0 border-top border-lg shadow-2\"><main class=\"container-fluid px-3 py-5 p-lg-6 p-xxl-8\"><div class=\"mb-6 mb-xl-10\"><div class=\"row g-3 align-items-center\"><div class=\"col\"><h1 class=\"ls-tight\">Dashboard</h1></div><div class=\"col\"><div class=\"hstack gap-2 justify-content-end\"><button type=\"button\" class=\"btn btn-sm btn-square btn-neutral rounded-circle d-xxl-none\" data-bs-toggle=\"offcanvas\" data-bs-target=\"#responsiveOffcanvas\" aria-controls=\"responsiveOffcanvas\"><i class=\"bi bi-three-dots\"></i></button></div></div></div></div><div class=\"row g-3 g-xxl-6\"><div class=\"col-xxl-8\"><div class=\"vstack gap-3 gap-md-6\"><div class=\"row g-3\"><div class=\"col-md col-sm-6\"><div class=\"card border-primary-hover\"><div class=\"card-body p-4\"><div class=\"d-flex align-items-center gap-2\"><i class=\"bi bi-bag-plus\"></i> <a href=\"javascript:void(0)\" hx-get=\"")
		if templ_7745c5c3_Err != nil {
