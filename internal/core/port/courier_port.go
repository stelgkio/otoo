...
type HermesService interface {
	...
	PrintVoucher(ctx echo.Context, courier4u *domain.Courier4uExtension, redcourier *domain.RedCourierExtension, vouchers []string, projectID, printType string) ([]byte, error)
