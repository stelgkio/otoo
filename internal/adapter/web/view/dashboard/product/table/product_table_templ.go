...
func ProductTable(projectId string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("\" x-init=\"init()\"><div class=\"row align-items-center g-6 mt-0 mb-6\"><div class=\"col-sm-6\"><div class=\"d-flex gap-2\"><div class=\"input-group input-group-sm input-group-inline w-100 w-md-50\"><span class=\"input-group-text\"><i class=\"bi bi-search me-2\"></i></span> <input type=\"search\" class=\"form-control ps-0\" placeholder=\"Search all products\" aria-label=\"Search\"></div></div></div></div><div class=\"border-top\"><div class=\"table-responsive\"><table class=\"table table-hover table-nowrap\"><thead><tr><th scope=\"col\" @click=\"sortTable(&#39;productId&#39;)\">Product ID <i :class=\"getSortIcon(&#39;productId&#39;)\"></i></th><th scope=\"col\">Name</th><th scope=\"col\">Price</th><th scope=\"col\">Category</th><th scope=\"col\">Type</th><th scope=\"col\">Total Orders</th></tr></thead> <tbody><template x-if=\"!loading &amp;&amp; totalItems === 0\"><tr><td colspan=\"8\">No products found.</td></tr></template><template x-for=\"product in paginatedProducts\" :key=\"product.id\"><tr><td x-text=\"product.productId\"></td><td x-text=\"product.name\"></td><td x-text=\"product.price\"></td><td x-text=\"product.category\"></td><td x-text=\"product.product_type\"></td><td x-text=\"product.total_orders\"></td></tr></template><!-- Fill remaining rows if less than 10 --><template x-for=\"i in 10 - paginatedProducts.length\" :key=\"&#39;empty&#39; + i\"><tr><td colspan=\"7\" class=\"py-7\"></td></tr></template></tbody></table></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
